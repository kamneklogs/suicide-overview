...
namespace suicide_overview.src.view
{
    internal partial class GraphicDonnut1 : UserControl
    {
        ...
        private void viewGraphic_Click(object sender, EventArgs e)
        {
            ...
            chart1.Series["s1"].Points.AddXY(mc.DeathsCountByCountry(country.Text, Int32.Parse(year1.Text)));
            chart1.Series["s1"].Points.AddXY(mc.DeathsCountByCountry(country.Text, Int32.Parse(year2.Text)));
            chart1.Series["s1"].Points.AddXY(mc.DeathsCountByCountry(country.Text, Int32.Parse(year3.Text)));
